    ...
    <div id="modal"
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md transform transition-all"> --}}
            ...
            <div class="relative w-full max-h-full bg-white dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="p-4">
                    <p class="text-md text-justify font-normal text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    <x-input.file wire:model="fileUpload" target="fileUpload" :error="$errors->first('fileUpload')" label="Select File"
                        ...
                        @if ($this->fileUpload)
                            <img class="object-cover w-full h-full rounded-md"
                                src="{{ $this->fileUpload->temporaryUrl() }}" alt="" />
                        @else
                    ...
                    <x-input.textarea wire:model.lazy="editing.message" id="award-entry" label="Message"
                        :error="$errors->first('editing.message')" />
                </div>
            </div>
            {{-- </div> --}}
...
{{-- <script type="text/javascript">
    ...
    window.closeModal = function(modalId) {
        ...
        document.getElementsByTagName('body')[0].classList.remove('overflow-y-hidden').emit("resetForm")
    }
